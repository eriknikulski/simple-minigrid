...
def register_minigrid_envs():
    ...
    register(
        id="SimpleMiniGrid-BlockedUnlockPickup-v0",
        entry_point="simple_minigrid.envs:BlockedUnlockPickupEnv",
    )

    # LavaCrossing
    # ----------------------------------------
    register(
        id="SimpleMiniGrid-LavaCrossingS9N1-v0",
        entry_point="simple_minigrid.envs:CrossingEnv",
        kwargs={"size": 9, "num_crossings": 1},
    )

    register(
        id="SimpleMiniGrid-LavaCrossingS9N2-v0",
        entry_point="simple_minigrid.envs:CrossingEnv",
        kwargs={"size": 9, "num_crossings": 2},
    )

    register(
        id="SimpleMiniGrid-LavaCrossingS9N3-v0",
        entry_point="simple_minigrid.envs:CrossingEnv",
        kwargs={"size": 9, "num_crossings": 3},
    )

    register(
        id="SimpleMiniGrid-LavaCrossingS11N5-v0",
        entry_point="simple_minigrid.envs:CrossingEnv",
    ...
    register(
        id="SimpleMiniGrid-SimpleCrossingS9N1-v0",
        entry_point="simple_minigrid.envs:CrossingEnv",
        kwargs={"size": 9, "num_crossings": 1, "obstacle_type": Wall},
    )

    register(
        id="SimpleMiniGrid-SimpleCrossingS9N2-v0",
        entry_point="simple_minigrid.envs:CrossingEnv",
        kwargs={"size": 9, "num_crossings": 2, "obstacle_type": Wall},
    )

    register(
        id="SimpleMiniGrid-SimpleCrossingS9N3-v0",
        entry_point="simple_minigrid.envs:CrossingEnv",
        kwargs={"size": 9, "num_crossings": 3, "obstacle_type": Wall},
    )

    register(
        id="SimpleMiniGrid-SimpleCrossingS11N5-v0",
        entry_point="simple_minigrid.envs:CrossingEnv",
    ...
    register(
        id="SimpleMiniGrid-DistShift1-v0",
        entry_point="simple_minigrid.envs:DistShiftEnv",
        kwargs={"strip2_row": 2},
    )

    register(
        id="SimpleMiniGrid-DistShift2-v0",
        entry_point="simple_minigrid.envs:DistShiftEnv",
        kwargs={"strip2_row": 5},
    )
    ...
    register(
        id="SimpleMiniGrid-DoorKey-5x5-v0",
        entry_point="simple_minigrid.envs:DoorKeyEnv",
        kwargs={"size": 5},
    )

    register(
        id="SimpleMiniGrid-DoorKey-6x6-v0",
        entry_point="simple_minigrid.envs:DoorKeyEnv",
        kwargs={"size": 6},
    )

    register(
        id="SimpleMiniGrid-DoorKey-8x8-v0",
        entry_point="simple_minigrid.envs:DoorKeyEnv",
        kwargs={"size": 8},
    )

    register(
        id="SimpleMiniGrid-DoorKey-16x16-v0",
        entry_point="simple_minigrid.envs:DoorKeyEnv",
        kwargs={"size": 16},
    )
    ...
    register(
        id="SimpleMiniGrid-Dynamic-Obstacles-5x5-v0",
        entry_point="simple_minigrid.envs:DynamicObstaclesEnv",
        kwargs={"size": 5, "n_obstacles": 2},
    )

    register(
        id="SimpleMiniGrid-Dynamic-Obstacles-Random-5x5-v0",
        entry_point="simple_minigrid.envs:DynamicObstaclesEnv",
        kwargs={"size": 5, "agent_start_pos": None, "n_obstacles": 2},
    )

    register(
        id="SimpleMiniGrid-Dynamic-Obstacles-6x6-v0",
        entry_point="simple_minigrid.envs:DynamicObstaclesEnv",
        kwargs={"size": 6, "n_obstacles": 3},
    )

    register(
        id="SimpleMiniGrid-Dynamic-Obstacles-Random-6x6-v0",
        entry_point="simple_minigrid.envs:DynamicObstaclesEnv",
        kwargs={"size": 6, "agent_start_pos": None, "n_obstacles": 3},
    )

    register(
        id="SimpleMiniGrid-Dynamic-Obstacles-8x8-v0",
        entry_point="simple_minigrid.envs:DynamicObstaclesEnv",
    )

    register(
        id="SimpleMiniGrid-Dynamic-Obstacles-16x16-v0",
        entry_point="simple_minigrid.envs:DynamicObstaclesEnv",
    ...
    register(
        id="SimpleMiniGrid-Fetch-5x5-N2-v0",
        entry_point="simple_minigrid.envs:FetchEnv",
        kwargs={"size": 5, "numObjs": 2},
    )

    register(
        id="SimpleMiniGrid-Fetch-6x6-N2-v0",
        entry_point="simple_minigrid.envs:FetchEnv",
        kwargs={"size": 6, "numObjs": 2},
    )

    register(id="SimpleMiniGrid-Fetch-8x8-N3-v0", entry_point="simple_minigrid.envs:FetchEnv")

    # FourRooms
    # ----------------------------------------

    register(
        id="SimpleMiniGrid-FourRooms-v0",
        entry_point="simple_minigrid.envs:FourRoomsEnv",
    )
    ...
    register(
        id="SimpleMiniGrid-GoToDoor-5x5-v0",
        entry_point="simple_minigrid.envs:GoToDoorEnv",
    )

    register(
        id="SimpleMiniGrid-GoToDoor-6x6-v0",
        entry_point="simple_minigrid.envs:GoToDoorEnv",
        kwargs={"size": 6},
    )

    register(
        id="SimpleMiniGrid-GoToDoor-8x8-v0",
        entry_point="simple_minigrid.envs:GoToDoorEnv",
        kwargs={"size": 8},
    )
    ...
    register(
        id="SimpleMiniGrid-GoToObject-6x6-N2-v0",
        entry_point="simple_minigrid.envs:GoToObjectEnv",
    )

    register(
        id="SimpleMiniGrid-GoToObject-8x8-N2-v0",
        entry_point="simple_minigrid.envs:GoToObjectEnv",
    ...
    register(
        id="SimpleMiniGrid-KeyCorridorS3R1-v0",
        entry_point="simple_minigrid.envs:KeyCorridorEnv",
        kwargs={"room_size": 3, "num_rows": 1},
    )

    register(
        id="SimpleMiniGrid-KeyCorridorS3R2-v0",
        entry_point="simple_minigrid.envs:KeyCorridorEnv",
        kwargs={"room_size": 3, "num_rows": 2},
    )

    register(
        id="SimpleMiniGrid-KeyCorridorS3R3-v0",
        entry_point="simple_minigrid.envs:KeyCorridorEnv",
        kwargs={"room_size": 3, "num_rows": 3},
    )

    register(
        id="SimpleMiniGrid-KeyCorridorS4R3-v0",
        entry_point="simple_minigrid.envs:KeyCorridorEnv",
        kwargs={"room_size": 4, "num_rows": 3},
    )

    register(
        id="SimpleMiniGrid-KeyCorridorS5R3-v0",
        entry_point="simple_minigrid.envs:KeyCorridorEnv",
        kwargs={"room_size": 5, "num_rows": 3},
    )

    register(
        id="SimpleMiniGrid-KeyCorridorS6R3-v0",
        entry_point="simple_minigrid.envs:KeyCorridorEnv",
    ...
    register(
        id="SimpleMiniGrid-LavaGapS5-v0",
        entry_point="simple_minigrid.envs:LavaGapEnv",
        kwargs={"size": 5},
    )

    register(
        id="SimpleMiniGrid-LavaGapS6-v0",
        entry_point="simple_minigrid.envs:LavaGapEnv",
        kwargs={"size": 6},
    )

    register(
        id="SimpleMiniGrid-LavaGapS7-v0",
        entry_point="simple_minigrid.envs:LavaGapEnv",
        kwargs={"size": 7},
    )
    ...
    register(
        id="SimpleMiniGrid-LockedRoom-v0",
        entry_point="simple_minigrid.envs:LockedRoomEnv",
    )
    ...
    register(
        id="SimpleMiniGrid-MemoryS17Random-v0",
        entry_point="simple_minigrid.envs:MemoryEnv",
        kwargs={"size": 17, "random_length": True},
    )

    register(
        id="SimpleMiniGrid-MemoryS13Random-v0",
        entry_point="simple_minigrid.envs:MemoryEnv",
        kwargs={"size": 13, "random_length": True},
    )

    register(
        id="SimpleMiniGrid-MemoryS13-v0",
        entry_point="simple_minigrid.envs:MemoryEnv",
        kwargs={"size": 13},
    )

    register(
        id="SimpleMiniGrid-MemoryS11-v0",
        entry_point="simple_minigrid.envs:MemoryEnv",
        kwargs={"size": 11},
    )

    register(
        id="SimpleMiniGrid-MemoryS9-v0",
        entry_point="simple_minigrid.envs:MemoryEnv",
        kwargs={"size": 9},
    )

    register(
        id="SimpleMiniGrid-MemoryS7-v0",
        entry_point="simple_minigrid.envs:MemoryEnv",
        kwargs={"size": 7},
    )
    ...
    register(
        id="SimpleMiniGrid-MultiRoom-N2-S4-v0",
        entry_point="simple_minigrid.envs:MultiRoomEnv",
        kwargs={"minNumRooms": 2, "maxNumRooms": 2, "maxRoomSize": 4},
    )

    register(
        id="SimpleMiniGrid-MultiRoom-N4-S5-v0",
        entry_point="simple_minigrid.envs:MultiRoomEnv",
        kwargs={"minNumRooms": 6, "maxNumRooms": 6, "maxRoomSize": 5},
    )

    register(
        id="SimpleMiniGrid-MultiRoom-N6-v0",
        entry_point="simple_minigrid.envs:MultiRoomEnv",
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-1Dl-v0",
        entry_point="simple_minigrid.envs:ObstructedMaze_1Dlhb",
        kwargs={"key_in_box": False, "blocked": False},
    )

    register(
        id="SimpleMiniGrid-ObstructedMaze-1Dlh-v0",
        entry_point="simple_minigrid.envs:ObstructedMaze_1Dlhb",
        kwargs={"key_in_box": True, "blocked": False},
    )

    register(
        id="SimpleMiniGrid-ObstructedMaze-1Dlhb-v0",
        entry_point="simple_minigrid.envs:ObstructedMaze_1Dlhb",
    )

    register(
        id="SimpleMiniGrid-ObstructedMaze-2Dl-v0",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full",
        kwargs={
            "agent_room": (2, 1),
            "key_in_box": False,
            "blocked": False,
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-2Dlh-v0",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full",
        kwargs={
            "agent_room": (2, 1),
            "key_in_box": True,
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-2Dlhb-v0",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full",
        kwargs={
            "agent_room": (2, 1),
            "key_in_box": True,
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-1Q-v0",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full",
        kwargs={
            "agent_room": (1, 1),
            "key_in_box": True,
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-2Q-v0",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full",
        kwargs={
            "agent_room": (2, 1),
            "key_in_box": True,
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-Full-v0",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full",
    )
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-2Dlhb-v1",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full_V1",
        kwargs={
            "agent_room": (2, 1),
            "key_in_box": True,
            "blocked": True,
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-1Q-v1",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full_V1",
        kwargs={
            "agent_room": (1, 1),
            "key_in_box": True,
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-2Q-v1",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full_V1",
        kwargs={
            "agent_room": (2, 1),
            "key_in_box": True,
    ...
    register(
        id="SimpleMiniGrid-ObstructedMaze-Full-v1",
        entry_point="simple_minigrid.envs:ObstructedMaze_Full_V1",
    )
    ...
    register(
        id="SimpleMiniGrid-Playground-v0",
        entry_point="simple_minigrid.envs:PlaygroundEnv",
    )
    ...
    register(
        id="SimpleMiniGrid-PutNear-6x6-N2-v0",
        entry_point="simple_minigrid.envs:PutNearEnv",
    )

    register(
        id="SimpleMiniGrid-PutNear-8x8-N3-v0",
        entry_point="simple_minigrid.envs:PutNearEnv",
    ...
    register(
        id="SimpleMiniGrid-RedBlueDoors-6x6-v0",
        entry_point="simple_minigrid.envs:RedBlueDoorEnv",
        kwargs={"size": 6},
    )

    register(
        id="SimpleMiniGrid-RedBlueDoors-8x8-v0",
        entry_point="simple_minigrid.envs:RedBlueDoorEnv",
    )
    ...
    register(id="SimpleMiniGrid-Unlock-v0", entry_point="simple_minigrid.envs:UnlockEnv")

    # UnlockPickup
    # ----------------------------------------

    register(
        id="SimpleMiniGrid-UnlockPickup-v0",
        entry_point="simple_minigrid.envs:UnlockPickupEnv",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:GoToRedBallGrey",
    )

    register(
        id="BabyAI-GoToRedBall-v0",
        entry_point="simple_minigrid.envs.babyai:GoToRedBall",
    )

    register(
        id="BabyAI-GoToRedBallNoDists-v0",
        entry_point="simple_minigrid.envs.babyai:GoToRedBallNoDists",
    )

    register(
        id="BabyAI-GoToObj-v0",
        entry_point="simple_minigrid.envs.babyai:GoToObj",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:GoToLocal",
    )
    ...
    register(
        id="BabyAI-GoTo-v0",
        entry_point="simple_minigrid.envs.babyai:GoTo",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:GoToImpUnlock",
    )

    register(
        id="BabyAI-GoToSeq-v0",
        entry_point="simple_minigrid.envs.babyai:GoToSeq",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:GoToRedBlueBall",
    )

    register(
        id="BabyAI-GoToDoor-v0",
        entry_point="simple_minigrid.envs.babyai:GoToDoor",
    )

    register(
        id="BabyAI-GoToObjDoor-v0",
        entry_point="simple_minigrid.envs.babyai:GoToObjDoor",
    )
    ...
    register(
        id="BabyAI-Open-v0",
        entry_point="simple_minigrid.envs.babyai:Open",
    )

    register(
        id="BabyAI-OpenRedDoor-v0",
        entry_point="simple_minigrid.envs.babyai:OpenRedDoor",
    )

    register(
        id="BabyAI-OpenDoor-v0",
        entry_point="simple_minigrid.envs.babyai:OpenDoor",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:OpenTwoDoors",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:OpenDoorsOrder",
        kwargs={"num_doors": 2},
    )
    ...
    register(
        id="BabyAI-Pickup-v0",
        entry_point="simple_minigrid.envs.babyai:Pickup",
    )

    register(
        id="BabyAI-UnblockPickup-v0",
        entry_point="simple_minigrid.envs.babyai:UnblockPickup",
    )

    register(
        id="BabyAI-PickupLoc-v0",
        entry_point="simple_minigrid.envs.babyai:PickupLoc",
    )

    register(
        id="BabyAI-PickupDist-v0",
        entry_point="simple_minigrid.envs.babyai:PickupDist",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:PickupAbove",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:PutNextLocal",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:PutNext",
    ...
    register(
        id="BabyAI-Unlock-v0",
        entry_point="simple_minigrid.envs.babyai:Unlock",
    )

    register(
        id="BabyAI-UnlockLocal-v0",
        entry_point="simple_minigrid.envs.babyai:UnlockLocal",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:KeyInBox",
    )

    register(
        id="BabyAI-UnlockPickup-v0",
        entry_point="simple_minigrid.envs.babyai:UnlockPickup",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:BlockedUnlockPickup",
    )

    register(
        id="BabyAI-UnlockToUnlock-v0",
        entry_point="simple_minigrid.envs.babyai:UnlockToUnlock",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:ActionObjDoor",
    )

    register(
        id="BabyAI-FindObjS5-v0",
        entry_point="simple_minigrid.envs.babyai:FindObjS5",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:KeyCorridor",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:OneRoomS8",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:MoveTwoAcross",
        kwargs={"room_size": 5, "objs_per_room": 2},
    )
    ...
    register(
        id="BabyAI-Synth-v0",
        entry_point="simple_minigrid.envs.babyai:Synth",
    )
    ...
    register(
        ...
        entry_point="simple_minigrid.envs.babyai:SynthLoc",
    )

    register(
        id="BabyAI-SynthSeq-v0",
        entry_point="simple_minigrid.envs.babyai:SynthSeq",
    )

    register(
        id="BabyAI-MiniBossLevel-v0",
        entry_point="simple_minigrid.envs.babyai:MiniBossLevel",
    )

    register(
        id="BabyAI-BossLevel-v0",
        entry_point="simple_minigrid.envs.babyai:BossLevel",
    )

    register(
        id="BabyAI-BossLevelNoUnlock-v0",
        entry_point="simple_minigrid.envs.babyai:BossLevelNoUnlock",
    )
