...
from simple_minigrid.manual_control import ManualControl
from simple_minigrid.wrappers import ImgObsWrapper, RGBImgPartialObsWrapper
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="SimpleMiniGrid-LavaGapS7-v0",
    )
    parser.add_argument(
        "--seed",
        type=int,
