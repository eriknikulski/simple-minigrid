...
from simple_minigrid.core.constants import OBJECT_TO_IDX, TILE_PIXELS
from simple_minigrid.core.world_object import Wall, WorldObj
from simple_minigrid.utils.rendering import (
    downsample,
    fill_coords,
    highlight_img,
    point_in_rect,
