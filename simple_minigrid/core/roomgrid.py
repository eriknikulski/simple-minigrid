...
from simple_minigrid.core.world_object import Ball, Box, Door, Key, WorldObj
from simple_minigrid.simple_minigrid_env import SimpleMiniGridEnv


def reject_next_to(env: SimpleMiniGridEnv, pos: tuple[int, int]):
    """
...
class Room:
    ...
    def rand_pos(self, env: SimpleMiniGridEnv) -> tuple[int, int]:
        topX, topY = self.top
...
class RoomGrid(SimpleMiniGridEnv):
    """
