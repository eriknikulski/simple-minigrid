...
from simple_minigrid.envs.babyai.core.verifier import (
    ActionInstr,
    AfterInstr,
    AndInstr,
    BeforeInstr,
...
from simple_minigrid.simple_minigrid_env import MissionSpace
...
class BabyAIMissionSpace(MissionSpace):
    """
    Class that mimics the behavior required by minigrid.simple_minigrid_env.MissionSpace,
