...
from simple_minigrid.core.world_object import Goal, Lava
from simple_minigrid.simple_minigrid_env import SimpleMiniGridEnv


class CrossingEnv(SimpleMiniGridEnv):
    """
    ## Description
    ...
    - `Lava` :
        - `SimpleMiniGrid-LavaCrossingS9N1-v0`
        - `SimpleMiniGrid-LavaCrossingS9N2-v0`
        - `SimpleMiniGrid-LavaCrossingS9N3-v0`
        - `SimpleMiniGrid-LavaCrossingS11N5-v0`

    - otherwise :
        - `SimpleMiniGrid-SimpleCrossingS9N1-v0`
        - `SimpleMiniGrid-SimpleCrossingS9N2-v0`
        - `SimpleMiniGrid-SimpleCrossingS9N3-v0`
        - `SimpleMiniGrid-SimpleCrossingS11N5-v0`
