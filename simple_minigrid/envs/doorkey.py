...
from simple_minigrid.core.world_object import Door, Goal, Key
from simple_minigrid.simple_minigrid_env import SimpleMiniGridEnv


class DoorKeyEnv(SimpleMiniGridEnv):
    """
    ## Description
    ...
    - `SimpleMiniGrid-DoorKey-5x5-v0`
    - `SimpleMiniGrid-DoorKey-6x6-v0`
    - `SimpleMiniGrid-DoorKey-8x8-v0`
    - `SimpleMiniGrid-DoorKey-16x16-v0`
