...
from simple_minigrid.core.world_object import Ball, Goal
from simple_minigrid.simple_minigrid_env import SimpleMiniGridEnv


class DynamicObstaclesEnv(SimpleMiniGridEnv):
    """
    ## Description
    ...
    - `SimpleMiniGrid-Dynamic-Obstacles-5x5-v0`
    - `SimpleMiniGrid-Dynamic-Obstacles-Random-5x5-v0`
    - `SimpleMiniGrid-Dynamic-Obstacles-6x6-v0`
    - `SimpleMiniGrid-Dynamic-Obstacles-Random-6x6-v0`
    - `SimpleMiniGrid-Dynamic-Obstacles-8x8-v0`
    - `SimpleMiniGrid-Dynamic-Obstacles-16x16-v0`
