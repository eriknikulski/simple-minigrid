...
from simple_minigrid.core.world_object import Ball, Key
from simple_minigrid.simple_minigrid_env import SimpleMiniGridEnv


class FetchEnv(SimpleMiniGridEnv):
    """
    ## Description
    ...
    - `SimpleMiniGrid-Fetch-5x5-N2-v0`
    - `SimpleMiniGrid-Fetch-6x6-N2-v0`
    - `SimpleMiniGrid-Fetch-8x8-N3-v0`
