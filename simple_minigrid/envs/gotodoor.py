...
from simple_minigrid.core.world_object import Door
from simple_minigrid.simple_minigrid_env import SimpleMiniGridEnv


class GoToDoorEnv(SimpleMiniGridEnv):
    """
    ## Description
    ...
    - `SimpleMiniGrid-GoToDoor-5x5-v0`
    - `SimpleMiniGrid-GoToDoor-6x6-v0`
    - `SimpleMiniGrid-GoToDoor-8x8-v0`
