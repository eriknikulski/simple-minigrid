...
from simple_minigrid.core.constants import COLOR_NAMES
...
class KeyCorridorEnv(RoomGrid):
    ...
    - `SimpleMiniGrid-KeyCorridorS3R1-v0`
    - `SimpleMiniGrid-KeyCorridorS3R2-v0`
    - `SimpleMiniGrid-KeyCorridorS3R3-v0`
    - `SimpleMiniGrid-KeyCorridorS4R3-v0`
    - `SimpleMiniGrid-KeyCorridorS5R3-v0`
    - `SimpleMiniGrid-KeyCorridorS6R3-v0`
