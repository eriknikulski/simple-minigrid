...
class MemoryEnv(SimpleMiniGridEnv):
    ...
    - `SimpleMiniGrid-MemoryS17Random-v0`
    - `SimpleMiniGrid-MemoryS13Random-v0`
    - `SimpleMiniGrid-MemoryS13-v0`
    - `SimpleMiniGrid-MemoryS11-v0`
