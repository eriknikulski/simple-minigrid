...
from simple_minigrid.core.world_object import Door, Goal, Wall
...
class MultiRoomEnv(SimpleMiniGridEnv):
    """
    ## Description
    ...
    - `SimpleMiniGrid-MultiRoom-N2-S4-v0` (two small rooms)
    - `SimpleMiniGrid-MultiRoom-N4-S5-v0` (four rooms)
    - `SimpleMiniGrid-MultiRoom-N6-v0` (six rooms)
