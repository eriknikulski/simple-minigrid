...
from simple_minigrid.core.constants import COLOR_NAMES, DIR_TO_VEC
from simple_minigrid.core.mission import MissionSpace
from simple_minigrid.core.roomgrid import RoomGrid
from simple_minigrid.core.world_object import Ball, Box, Key
...
class ObstructedMazeEnv(RoomGrid):
    ...
    - `SimpleMiniGrid-ObstructedMaze-1Dl-v0`
    - `SimpleMiniGrid-ObstructedMaze-1Dlh-v0`
    - `SimpleMiniGrid-ObstructedMaze-1Dlhb-v0`
    - `SimpleMiniGrid-ObstructedMaze-2Dl-v0`
    - `SimpleMiniGrid-ObstructedMaze-2Dlh-v0`
    - `SimpleMiniGrid-ObstructedMaze-2Dlhb-v0`
    - `SimpleMiniGrid-ObstructedMaze-2Dlhb-v1`
    - `SimpleMiniGrid-ObstructedMaze-1Q-v0`
    - `SimpleMiniGrid-ObstructedMaze-1Q-v1`
    - `SimpleMiniGrid-ObstructedMaze-2Q-v0`
    - `SimpleMiniGrid-ObstructedMaze-2Q-v1`
    - `SimpleMiniGrid-ObstructedMaze-Full-v0`
    - `SimpleMiniGrid-ObstructedMaze-Full-v1`
