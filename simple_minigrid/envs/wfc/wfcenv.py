...
from simple_minigrid.core.constants import OBJECT_TO_IDX
from simple_minigrid.core.grid import Grid
from simple_minigrid.core.mission import MissionSpace
from simple_minigrid.envs.wfc.config import WFC_PRESETS_ALL, WFCConfig
from simple_minigrid.envs.wfc.graphtransforms import EdgeDescriptor, GraphTransforms
from simple_minigrid.envs.wfc.wfclogic.control import execute_wfc
...
class WFCEnv(SimpleMiniGridEnv):
    """
    ## Description
    ...
    - `SimpleMiniGrid-WFC-MazeSimple-v0`
    - `SimpleMiniGrid-WFC-DungeonMazeScaled-v0`
    - `SimpleMiniGrid-WFC-RoomsFabric-v0`
    - `SimpleMiniGrid-WFC-ObstaclesBlackdots-v0`
    - `SimpleMiniGrid-WFC-ObstaclesAngular-v0`
    - `SimpleMiniGrid-WFC-ObstaclesHogs3-v0`
    ...
    ```python
    import gymnasium
    from simple_minigrid.envs.wfc.config import register_wfc_presets, WFC_PRESETS_INCONSISTENT, WFC_PRESETS_SLOW
