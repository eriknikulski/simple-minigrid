...
from simple_minigrid.envs.wfc.wfclogic.adjacency import adjacency_extraction
from simple_minigrid.envs.wfc.wfclogic.patterns import (
    make_pattern_catalog_with_rotations,
    pattern_grid_to_tiles,
)
from simple_minigrid.envs.wfc.wfclogic.solver import (
    Contradiction,
    StopEarly,
    TimedOut,
